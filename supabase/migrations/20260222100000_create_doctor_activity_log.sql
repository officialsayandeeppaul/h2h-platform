-- H2H Healthcare: Doctor activity log for console (status changes, prescription edits)
...
COMMENT ON TABLE public.doctor_activity_log IS 'Log of doctor actions: appointment status changes, prescription edits, etc.';
