-- Quick Booking: service + name + mobile (no doctor). Super-admin managed. Optional payment.
...
COMMENT ON TABLE public.quick_bookings IS 'Lightweight bookings: service + name + mobile; optional Razorpay';
COMMENT ON TABLE public.quick_booking_settings IS 'Singleton settings for Quick Booking payment (super admin)';
