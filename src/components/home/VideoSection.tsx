...
const HeroVideoDialog = dynamic(
  () => import("@/components/ui/hero-video-dialog").then((m) => ({ default: m.HeroVideoDialog })),
  {
    ssr: false,
    loading: () => (
      <div className="aspect-[9/16] sm:aspect-video w-full rounded-2xl sm:rounded-3xl bg-slate-100 animate-pulse" />
    ),
  }
);
...
export function VideoSection() {
  return (
    <section className="relative py-16 sm:py-20 md:py-28 bg-gradient-to-b from-white via-gray-50/50 to-white overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-72 h-72 bg-blue-100/30 rounded-full blur-2xl pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-80 h-80 bg-cyan-100/25 rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          <div className="hidden lg:block order-2 lg:order-1">
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-600 text-[11px] font-semibold text-white">
                H2H
              </div>
              <div>
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-2 sm:-bottom-6 sm:-left-4 bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-gray-100 z-10 max-w-[130px] transform-gpu transition-transform duration-200 hover:-translate-y-0.5">
              ...
              <div className="absolute -top-4 -right-2 sm:-top-6 sm:-right-4 bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-gray-100 z-10 max-w-[130px] transform-gpu transition-transform duration-200 hover:-translate-y-0.5">
