      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-10">
              <Button size="lg" className="h-14 px-8 text-base font-semibold bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 font-[family-name:var(--font-poppins)]" asChild>
                <Link href="/about">
                  Learn Our Story
          ...
          <div className="relative">
            <div className="relative">
              ...
              {/* Portrait — face clear; mobile chips sit low on the sides */}
              <div className="relative w-full overflow-hidden rounded-2xl border border-gray-800 bg-gray-950 aspect-[4/5] min-h-[280px] max-sm:min-h-[300px] max-sm:max-h-[min(72vh,520px)] sm:aspect-[3/4] sm:min-h-[420px] sm:max-h-[560px]">
                <Image
                  ...
                  priority={false}
                />
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-gray-950 via-gray-950/20 to-transparent max-sm:via-transparent sm:via-gray-950/40" />
                ...
                <div className="absolute left-2 top-2 z-10 sm:hidden">
                  <div className="flex max-w-[9.5rem] items-center gap-1.5 rounded-lg border border-gray-700/90 bg-gray-950/90 px-2 py-1.5 backdrop-blur-sm">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-[11px] font-medium leading-tight text-white">17+ Years</p>
                      <p className="truncate text-[9px] leading-tight text-gray-400">Elite sport</p>
                    </div>
                  </div>
                </div>
                <div className="absolute right-3 top-[48%] z-10 -translate-y-1/2 sm:hidden">
                  <div className="flex max-w-[9.5rem] items-center gap-1.5 rounded-lg border border-gray-700/90 bg-gray-950/90 px-2 py-1.5 shadow-lg backdrop-blur-sm">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-emerald-500/20">
                      <Trophy className="h-3 w-3 text-emerald-400" />
                    </div>
                    <div className="min-w-0">
                      <p className="truncate text-[11px] font-medium leading-tight text-white">Pro & national</p>
                      <p className="truncate text-[9px] leading-tight text-gray-400">Squads</p>
                    </div>
                  </div>
                </div>
                <div className="absolute right-2 top-2 z-10 flex items-center gap-1.5 rounded-full border border-gray-700/80 bg-gray-950/90 px-2.5 py-1 backdrop-blur-sm sm:hidden">
                  <div className="h-2 w-2 rounded-full bg-emerald-500" />
                  <span className="text-[11px] font-medium text-white">Verified</span>
                </div>
              </div>

              {/* Desktop / tablet: floating badges (sm+) */}
              <div className="pointer-events-none absolute inset-0 hidden sm:block">
                <div className="pointer-events-auto absolute -right-2 -top-2 flex items-center gap-2 rounded-full border border-gray-700 bg-gray-900/90 px-4 py-2 backdrop-blur-sm">
                  <div className="h-2.5 w-2.5 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-[13px] font-medium text-white">Verified Expert</span>
                </div>

                <div className="pointer-events-auto absolute -left-4 top-[18%] rounded-xl border border-gray-700 bg-gray-900/90 px-4 py-3 backdrop-blur-sm">
                  <div className="flex items-center gap-2">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500/20">
                      <Award className="h-4 w-4 text-blue-400" />
                    </div>
                    <div>
                      <p className="text-[13px] font-medium text-white">17+ Years</p>
                      <p className="text-[11px] text-gray-500">Elite sport medicine</p>
                    </div>
                  </div>
                </div>

                <div className="pointer-events-auto absolute -right-4 top-[48%] rounded-xl border border-gray-700 bg-gray-900/90 px-4 py-3 backdrop-blur-sm">
                  <div className="flex items-center gap-2">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-500/20">
                      <Trophy className="h-4 w-4 text-emerald-400" />
                    </div>
                    <div>
                      <p className="text-[13px] font-medium text-white">Pro & national</p>
                      <p className="text-[11px] text-gray-500">Squads & franchises</p>
                    </div>
                  </div>
                </div>

                <div className="pointer-events-auto absolute -left-4 bottom-20 rounded-xl border border-gray-700 bg-gray-900/90 px-4 py-3 backdrop-blur-sm">
                  <div className="flex items-center gap-2">
