...
export const DEFAULT_LOCATIONS: Location[] = [
  {
    ...
    services: ['Pain Relief & Physiotherapy', 'Advanced Rehabilitation', 'Nutrition & Lifestyle', 'Mental Wellness', 'Therapeutic Yoga', 'Sports Performance', 'Digital Health'],
  ...
  },
  {
    ...
    timings: 'Mon-Sat: 8:00 AM - 8:00 PM, Sun: 9:00 AM - 5:00 PM',
    services: ['Pain Relief & Physiotherapy', 'Advanced Rehabilitation', 'Therapeutic Yoga', 'Nutrition & Lifestyle', 'Digital Health'],
